...
class IGAVNet18(nn.Module):
    def __init__(self, in_size, out_size, n_classes, middle_size, device):
        ...
        self.fgat3 = GAMBlock(self.out_size,device,block_size=18)
        self.u_d_maxpool3 = nn.MaxPool2d(kernel_size=2)
        
        self.fgat4 = GAMBlock(self.out_size,device,block_size=18)
        self.u_d_maxpool4 = nn.MaxPool2d(kernel_size=2)
        
        self.fgat5 = GAMBlock(self.out_size,device,block_size=18)
